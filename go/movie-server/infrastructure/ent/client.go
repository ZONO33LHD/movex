...
import (
	...
	"github.com/movex-dev/movie-server/infrastructure/ent/migrate"
...
// QueryVideos queries the videos edge of a Video.
func (c *VideoClient) QueryVideos(v *Video) *VideoQuery {
